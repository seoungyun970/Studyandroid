...
public class Chapter12Adapter extends RecyclerView.Adapter<MyHolder12> {
    private ArrayList<String> list;
    private Context context;

    public Chapter12Adapter(ArrayList<String> list) {
        this.list = list;
    }

    @Override
    public MyHolder12 onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.main_item, parent, false);
        return new MyHolder12(view);
    }

    @Override
    public void onBindViewHolder(MyHolder12 holder, int position) {
...
class MyHolder12 extends RecyclerView.ViewHolder {
    TextView tv;

    public MyHolder12(View itemView) {
        super(itemView);
